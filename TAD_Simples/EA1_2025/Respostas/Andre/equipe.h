...
/**
 * @brief Função que copia o conteúdo de um nome de uma equipe para uma nova
          variável
...
/**
 * @brief Funções getter - retorna um cálculo com base nos valores dos campos
 *        da estrutura
 * @param e - uma variável que armazena uma equipe
 * @return O id da equipe do jogador
 */
 ...
 *         Repare que os gols são "armazenados" nas variáveis idGols e
 *         nGolsPro.
 *         "idGols" armazena os ids dos jogadores que fizeram os gols daquele
 *         time;
 * @param e - uma equipe
...
/**
 * @brief Funções de incrementar (somar 1) uma variável específica (olhar
 *        título da função)
 * @param e - uma variável que armazena uma equipe
...
/**
 * @brief  Adiciona "um gol" aos gols de uma equipe. Na verdade, armazena o id
 *         do jogador que fez um gol pelo time (gol pró) no vetor
 *         correspondente.
 ...
 *        Ao contrário dos gols pro, não é necessário armazenar quem fez os
 *        gols;
 *        Apenas a quantidade
 * @param e - uma variável que armazena uma equipe
